...
public class GraphicsHandlerVisualTest extends Application {
	...
	*/
	private void setupCircle() {
		...
		shapeFactory = new SlideShapeFactory(points, 50, 50,blue,blue,startTime, duration,1);
	...
	*/
	private void setupPentagon() {
		...
		shapeFactory = new SlideShapeFactory(points, height,width,blue,blue,startTime, duration,1);
	...
	*/
	private void setupSquare() {
		...
		shapeFactory = new SlideShapeFactory(points, width, height,blue,blue,startTime, duration,1);
