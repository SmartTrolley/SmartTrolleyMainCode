...
public class PWSParser extends DefaultHandler {
	...
	*/
	...
	/*	if (elementName.equals("slideshow")) {
			...
			currentSlide = new Slide(attributes.getValue(0), attributes.getValue(1), attributes.getValue(2)); 
		} //TODO Add else if statements for attributes of slide sub-child elements*/
	}
