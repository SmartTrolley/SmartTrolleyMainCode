 ...
 * SmartTrolley
 *
 * This class contains a thread which the server runs for each client that is connected
 * This code is adapted from http://www.ase.md/~aursu/ClientServerThreads.html (Accessed on 1 Mar '14)
 *
